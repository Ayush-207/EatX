...
const Restaurant= ()=>{
    return (
        <>
        <div className="mt-20">
            <p className="text-black font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]">Order Your Meal</p>
            <h2 className="text-black font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]">Welcome, user</h2>
        </div>
        ...
        <div className="mb-10">
            <h2 className={styles.heroSubText}>FIND THE DISHES THAT MATCH YOUR TASTE</h2>
        </div>
